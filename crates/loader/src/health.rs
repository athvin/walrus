...
//! - `/ready`   — 200 iff bootstrap done (leases held + files open). **Never** gated on "backlog
//!   drained": a legitimately-behind loader is still *ready*; gating on lag flaps a busy pod out.
